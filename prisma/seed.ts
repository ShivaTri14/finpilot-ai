...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || "postgresql://neondb_owner:npg_bPt4pw7qBxiU@ep-tiny-snow-aw07koxr-pooler.c-12.us-east-1.aws.neon.tech/neondb?sslmode=require",
});
